...
public:
	...
	///订阅行情应答
	virtual void OnRspSubMarketData(SpecificInstrumentField *pSpecificInstrument, RspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

	///取消订阅行情应答
	virtual void OnRspUnSubMarketData(SpecificInstrumentField *pSpecificInstrument, RspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

	///订阅询价应答
	virtual void OnRspSubForQuoteRsp(SpecificInstrumentField *pSpecificInstrument, RspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

	///取消订阅询价应答
	virtual void OnRspUnSubForQuoteRsp(SpecificInstrumentField *pSpecificInstrument, RspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

	///深度行情通知
	virtual void OnRtnDepthMarketData(DepthMarketDataField *pDepthMarketData) {};
...
public:
	...
	static MdApi *CreateMdApi(const char *pszFlowPath = "", const bool bIsUsingUdp=false, const bool bIsMulticast=false);
